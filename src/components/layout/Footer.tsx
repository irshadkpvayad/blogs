...
export const Footer = () => {
  return (
    <footer className="bg-[#f9fafb] text-slate-900 py-12 px-4 sm:px-6 lg:px-8 mt-auto border-t border-slate-200 w-full relative z-10">
      <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
         <div className="flex flex-col gap-4 max-w-sm text-center md:text-left items-center md:items-start">
            ...
            <p className="text-xs text-slate-500 leading-relaxed font-medium">
              A modern Firebase-powered publishing platform for authored articles, reader communities, and editorial workflows.
            </p>
         </div>
         ...
         <div className="flex flex-wrap items-center justify-center gap-8 text-sm font-bold text-slate-600">
            ...
            <a href="#" className="hover:text-slate-900 transition-colors">Growth</a>
            <a href="#" className="hover:text-slate-900 transition-colors">Dashboard</a>
         </div>

         <div className="flex items-center justify-center gap-3">
            <button className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-400 hover:text-slate-900 hover:border-slate-300 transition-all shadow-sm">
