...
export const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 w-full bg-white/90 backdrop-blur-md z-50 py-4 px-4 sm:px-6 lg:px-8 border-b border-slate-100/50">
        <div className="max-w-[1400px] mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex items-center gap-2 mr-2">
              <button className="w-10 h-10 rounded-full border border-slate-200 flex items-center justify-center text-slate-400 hover:text-slate-900 transition-colors">
